<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/olives-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Olives & pickles</h2>
			<p>For olive lovers everywhere we being you a selection of olives grown by Bernal in Murcia a company set up in the fifties by Jose Bernal and today run by his grandchildren continuing the family tradition. </p>
			</div>
			<section id="sort">
			<span>sort by: </span>
