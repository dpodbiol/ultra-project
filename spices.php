<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/spices-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Spices & dry goods</h2>
			<p>With Saffron from La Mancha, rice from Valencia, paprika from Losar de la Vera, and fair-trade coffee from Nicaragua, let ultracomida bring you the best culinary products from around the globe.</p>
			</div>
			<section id="sort">
			<span>sort by: </span>
