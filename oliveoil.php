<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/oliveoil-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Olive Oil & Vinegar</h2>
			<p>The base notes and building blocks to all Spanish cuisine – ultracomida bring you the best quality oils and vinegars ensuring that you create a symphony in the kitchen. </p>
			</div>
			<section id="sort">
			<span>sort by: </span>
