<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/cheese-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Cheese</h2>
			<p>From the dense to the creamy, Manchego to La Yerbera, we boast an impressive selection of Spanish cheeses as well as a few award-winning Welsh cheeses. Why not accompany your cheese selection with a lovely quince paste common in every Spanish home used especially as an accompaniment with Manchego cheese.</p>
			</div>
			<section id="sort">
			<span>sort by: </span>
