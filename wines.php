<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/wines-img.jpg" alt="wines" />
			</div>
			<div class="textright">
			<h2>Wines</h2>
			<p>Ultracomida has an impressive selection of wines, sherries and beers from across Spain including emerging DO’s like Priorat as well as established areas such as Rioja .</p>
			</div>
			<section id="sort">
			<span>sort by: </span>
