<?php include("head.php"); ?>	
	...
	<?php include("menu-left.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/pans-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Paella pans</h2>
			<p>Want those authentic Spanish tastes and flavours? Get an authentic Spanish paella pan for your kitchen and master the culinary art of Spain’s national dish.</p>
			</div>
			<section id="sort">
			<span>sort by: </span>
