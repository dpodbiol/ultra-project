<?php include("head.php"); ?>	
	...
	<?php include("header.php"); ?>
		...
		<!--<img class="sidepromotion" src="../images/promotion_img.jpg" alt="spanish_products" />-->
			...
			<div class="imageleft">
			<img src="images/meat-img.jpg" alt="cheese" />
			</div>
			<div class="textright">
			<h2>Meat & fish</h2>
			<p>From Chorizo made using the finest Iberico pigs and employing artisan methods, 15 month aged Serrano ham to salt cured loin of tuna in olive oil from Andalucía, the ultracomida range offers the best examples of fish, cured and fresh meat.</p>
			</div>
			<section id="sort">
			<span>sort by: </span>
